...
### Spicy (optional — include if you have a clear read)

- **Q21** — My human arrives with a plan, not just a vibe. *(clarity)*
- **Q22** — My human says "you know what I mean" and expects that to be enough. *(clarity)*
- **Q23** — My human communicates like they are sending me clues in a scavenger hunt. *(clarity)*
- **Q24** — My human treats me like a genius sidekick. *(tone)*
- **Q25** — My human talks to me like the deadline is in seven seconds and everything is on fire. *(tone)*
- **Q26** — My human is not mean, but they do weaponize urgency. *(tone)*
- **Q27** — My human starts with "what if…". *(thinking style)*
- **Q28** — My human is here to ship the thing and go home. *(thinking style)*
- **Q29** — My human wants moonshots. *(thinking style)*
- **Q30** — My human lets me cook. *(autonomy)*
- **Q31** — My human grabs the pan back immediately. *(autonomy)*
...
```json
{
  "answers": [
    ...
    { "questionCode": "Q02", "value": 2, "reasoning": "Not really their style from what I've seen. They tend to over-specify rather than leave things implicit, which I appreciate. Low score." }
  ],
...
- Use `questionCode` values `Q01` through `Q32`. All 20 core (Q01–Q20) are required.
